...
import { UseWriteContractReturnType, UseReadContractReturnType, UseWatchContractEventReturnType } from "wagmi";
...
type SelectedChainId = IsContractsFileMissing<number, (typeof web3Config)["targetNetworks"][0]["id"]>;
...
> = {
  ...
  Partial<UseReadContractReturnType>,
  {
...
> = {
  ...
  Partial<UseWriteContractReturnType> & { args?: unknown[] },
  {
    functionName: TFunctionName;
